...
import com.accenture.automation.quality.center.config.KafkaProperties;
...
class AutomationQualityCenterKafkaResourceIT {
    ...
    void setup() {
        ...
        AutomationQualityCenterKafkaResource kafkaResource = new AutomationQualityCenterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/automation-quality-center-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/automation-quality-center-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
