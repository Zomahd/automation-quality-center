...
@RestController
@RequestMapping("/api/automation-quality-center-kafka")
public class AutomationQualityCenterKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AutomationQualityCenterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AutomationQualityCenterKafkaResource(KafkaProperties kafkaProperties) {
